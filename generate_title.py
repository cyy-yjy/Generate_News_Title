...
def set_args():
    ...
    parser.add_argument('--model_path', default='model', type=str, help='模型文件路径')
    parser.add_argument('--vocab_path', default='./vocab.txt', type=str, help='词表，该词表为小词表，并增加了一些新的标记')
    parser.add_argument('--batch_size', default=2, type=int, help='生成标题的个数')
    ...
    parser.add_argument('--max_len', type=int, default=1000, help='输入模型的最大长度，要比config中n_ctx小')
